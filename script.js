const products = {
  product2: {
    ...
    options: [{ weight: "1L", price: 300.00 }],
    basePrice: 300,
    weight: "1L",
    img: "images/p2.png",
  ...
  product3: {
    name: "Cold Pressed Groundnut Oil ",
    options: [{ weight: "500ml", price: 150.00 }],
    basePrice: 150,
    weight: "500ml",
    img: "images/p3.png",
  ...
  product4: {
    ...
    options: [{ weight: "1L", price: 450.00 }],
    basePrice: 450,
    weight: "1L",
    img: "images/p4.png",
  ...
  product5: {
    name: "Cold Pressed Gingely Oil ",
    options: [{ weight: "500ml", price: 225.00 }],
    basePrice: 225,
    weight: "500ml",
    img: "images/p5.png",
  ...
  product6: {
    ...
    options: [{ weight: "1L", price: 430.00 }],
    basePrice: 430,
    weight: "1L",
    img: "images/p6.png",
  ...
  product7: {
    name: "Cold Pressed Coconut Oil ",
    options: [{ weight: "500ml", price: 215.00 }],
    basePrice: 215,
    weight: "500ml",
    img: "images/p7.png",
  ...
  karupu_kavuni: {
    name: "karupu kavuni Porridge",
    options: [
        { weight: "250g", price: 134.00 },
        { weight: "500g", price: 268.00 },
    ],
    basePrice: 134,
    weight: "250g / 500g",
  ...
  product13: {
    ...
    gallery: [
      { type: "image", src: "p13rr.jpg" },
      { type: "image", src: "p13rrr.jpg" },
    ],
  },
  product14: {
  ...
  product19: {
    ...
    options: [
        { weight: "250g", price: 93.00 },
        { weight: "500g", price: 186.00 },
    ],
    basePrice: 93,
    weight: "250g / 500g",
    img: "images/p19.png",
  ...
  product21: {
    ...
    options: [{ weight: "225g", price: 134.00 }],
    basePrice: 134,
    weight: "225g",
    img: "images/p21.png",
  ...
  product22: {
    ...
    options: [{ weight: "250g", price: 130.00 }],
    basePrice: 130,
    weight: "250g",
    img: "p22s.jpg",
    ...
    gallery: [
      { type: "image", src: "p22s.jpg" },
      { type: "image", src: "images/p22r.png" },
    ],
  },
  product32: {
    name: "Kattuyanam Rice Flour",
    options: [{ weight: "250g", price: 130.00 }],
    basePrice: 130,
    weight: "250g",
    img: "p32.jpg",
    desc: "Wholesome rice flour made from traditional Kattuyanam rice, known for its rich iron and fiber content. Helps boost energy, supports digestion, and keeps you active throughout the day.",
    video: "images/p21v.mp4",
    gallery: [
      { type: "image", src: "p32.jpg" },
      { type: "image", src: "images/p22r.png" },
    ],
  },
  product23: {
    ...
    gallery: [
      { type: "image", src: "p23rr.jpg" },
      { type: "image", src: "p23s.jpg" },
    ],
  },
  product24: {
  ...
  product26: {
    ...
    options: [{ weight: "120g", price: 99.00 }],
    basePrice: 99,
    weight: "120g",
    img: "images/p26r.png",
  ...
  product28: {
    ...
    options: [{ weight: "120g", price: 81.00 }],
    basePrice: 81,
    weight: "120g",
    img: "images/p28r.jpg",
 ...
 */
function openWhatsAppOrderDirect(productKey, weight, price) {
